$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*Hello，我叫KingYiFan，是一位超辣鸡的程序猿</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我的主要工作是Java开发</div>",2000);
	...
	w.load("<p><div class='writecode'>KingYiFan</div>");
	w.load("<div class='writecode'>单身狗</div>");
	w.load("<div class='writecode'>KingYiFan、独狼技术团队创始人</div></p>");
	w.load("<div class='writecode'>关注微信公众号:独狼技术团队。获取本人联系方式</div></p>");
	w.load("<h1 class='writecode'>联系</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>Mail:<a href='itw@tom.com' target='_blank'>itw@tom.com</li>");
	w.load("<li class='writecode'>Blog:<a href='https://blog.cnbuilder.cn/' target='_blank'>https://blog.cnbuilder.cn/</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>能用Java日常开发</li>");
	w.load("<li class='writecode'>熟练ssm框架使用</li>");
    w.load("<li class='writecode'>对Linux情有独钟</li>");
	w.load("<li class='writecode'>会吹牛逼</li>");
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ:69673804</div>");
	c.load("<div class='comment writecode'>&nbsp;*Mail:itw@tom.com</div>");
